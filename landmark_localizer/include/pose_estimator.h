...
#include "p3p.h"
#include "landmark_localizer/LandmarkArray.h"
#include "landmark_localizer/Landmark.h"
...
private:
  ...
  std::vector<cv::Point> distorted_detection_centers_;
...
public:
   ...
   */
  bool estimateBodyPose(std::vector<ImgLandmark> &detected_landmarks, double time_to_predict);
